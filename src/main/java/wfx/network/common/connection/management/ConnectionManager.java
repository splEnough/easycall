...
public interface ConnectionManager extends Closeable {
     ...
     * @return
     */
    Connection getTargetConnectionByChannelId(Integer channelId);
    ...
    /**
     * 通过Channel的id删除某个连接
     * @param channelId 要删除的ChannelId
     * @return
     */
    boolean removeConnection(Integer channelId);
}
